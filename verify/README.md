...
##Usage
Below is a set of command line options that are used with the verifiers. Note that not all verifies support all options. Use `-h` to see available options for each verifier.
